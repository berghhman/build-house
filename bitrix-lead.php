<?php
/**
 * Приём заявок с сайта buildhousespb.ru и отправка письма на почту.
 *
 * Всё происходит на этом сервере (reg.ru, Россия): скрипт принимает данные
 ...
 * и никакой секретный ключ наружу, в код страницы, не передаётся.
